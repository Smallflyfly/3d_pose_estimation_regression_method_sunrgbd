  ...
  def train_model(self, max_iters):
    ...
    while iter < max_iters + 1:
      ...
      if iter == 1 or now - last_summary_time > cfg.TRAIN.SUMMARY_INTERVAL:
        ...
        rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, total_loss, summary, loss_depth, loss_rotation = \
        ...
        rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, total_loss, loss_depth, loss_rotation = \
          self.net.train_step(blobs, self.optimizer)   # fang fangpengfei  add points2d_loss
      ...
      if iter % (cfg.TRAIN.DISPLAY) == 0:
        print('iter: %d / %d, total loss: %.6f\n >>> rpn_loss_cls: %.6f\n '
              '>>> rpn_loss_box: %.6f\n >>> loss_cls: %.6f\n >>> loss_box: %.6f\n >>> loss_depth: %.6f\n >>> loss_rotation: %.6f\n >>> lr: %f' % \
              (iter, max_iters, total_loss, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss_depth, loss_rotation, lr)) #fang fangpengfei add points2d loss
