...
class pascal_voc(imdb):
  ...
  def _load_pascal_annotation(self, index):
    ...
    # gt_grid = np.zeros((num_objs), dtype=np.int32)
    ...
    for ix, obj in enumerate(objs):
      ...
      position = obj.find('position') #fang
      # grid = int(position.find('grid').text)
      ...
      # angle_num = int(xangle / 10) # 0 ~ 35  36 part for 360
      # if angle_num >= 36 or angle_num < 0:
      #   print(axt1)
      #   print(ax, ay)
      #   print(angle_num)
      #   print('angle error')
